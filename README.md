...
1. Initialize and activate a virtualenv:
  ...
  $ source env/bin/activate (window:.\env\Scripts\activate.bat)
  ```
...
3. Run the development server:
  ```
  $ export FLASK_APP=app.py(Command Prompt:SET FLASK_APP=app.py)(PowerShell:$env:FLASK_APP = "app.py")
  $ export FLASK_ENV=development # enables debug mode(Command Prompt:SET FLASK_ENV=development)($env:FLASK_ENV = "development")
  $ python3 app.py
  ```
